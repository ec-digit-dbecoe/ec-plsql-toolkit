...
REM Script for creating the data set (DS_GEN_TUTORIAL)
REM 
...
DECLARE
   l_set_id ds_data_sets.set_id%TYPE := ds_utility_krn.get_data_set_def_by_name('DS_GEN_TUTORIAL');
BEGIN
   ...
   ds_utility_krn.update_table_properties(p_set_id=>l_set_id, p_table_name=>'TMP_ORG_ENTITIES', p_row_count=>3);   -- 3 institutions (root level)
   ...
   ds_utility_krn.update_table_column_properties(p_set_id=>l_set_id, p_table_name=>'TMP_ORG_ENTITIES', p_col_name=>'OEN_NAME', p_gen_type=>'SQL', p_params=>
   ...
   ds_utility_krn.update_table_column_properties(p_set_id=>l_set_id, p_table_name=>'TMP_ORG_ENTITIES', p_col_name=>'OEN_CD', p_gen_type=>'SQL', p_params=>
...
END#'
   ...
   ds_utility_krn.update_table_column_properties(p_set_id=>l_set_id, p_table_name=>'TMP_PERSONS', p_col_name=>'FIRST_NAME', p_gen_type=>'SQL', p_params=>
      q'#ds_masker_krn.random_value_from_data_set(p_set_col_name=>'INT_GIVEN_NAMES_250.GIVEN_NAME_ASCII',p_col_len=>30,p_seed=>SEED)#'
   );
   ds_utility_krn.update_table_column_properties(p_set_id=>l_set_id, p_table_name=>'TMP_PERSONS', p_col_name=>'LAST_NAME', p_gen_type=>'SQL', p_params=>
   ...
   ds_utility_krn.update_table_column_properties(p_set_id=>l_set_id, p_table_name=>'TMP_PERSONS', p_col_name=>'FULL_NAME', p_gen_type=>'SQL', p_params=>
      q'#:first_name||' '||:last_name#'
   );
   ds_utility_krn.update_table_column_properties(p_set_id=>l_set_id, p_table_name=>'TMP_PERSONS', p_col_name=>'GENDER', p_gen_type=>'SQL', p_params=>
      q'#ds_masker_krn.random_value_from_data_set(p_set_col_name=>'INT_GIVEN_NAMES_250.GENDER',p_col_len=>1,p_seed=>SEED)#'
   );
   ds_utility_krn.update_table_column_properties(p_set_id=>l_set_id, p_table_name=>'TMP_PERSONS', p_col_name=>'BIRTH_DATE', p_gen_type=>'SQL', p_params=>
      q'#ds_masker_krn.random_date(p_min_date=>ADD_MONTHS(TRUNC(SYSDATE),-65*12),p_max_date=>ADD_MONTHS(TRUNC(SYSDATE),-21*12)) #'
   );
   ds_utility_krn.update_table_column_properties(p_set_id=>l_set_id, p_table_name=>'TMP_PERSONS', p_col_name=>'TITLE', p_gen_type=>'SQL', p_null_value_pct=>20, p_params=>
      q'#CASE WHEN :gender = 'M' THEN 'Mr' ELSE ds_masker_krn.random_value_from_list(p_values=>'Ms, Mrs, Miss') END#'
   );
   ds_utility_krn.update_table_column_properties(p_set_id=>l_set_id, p_table_name=>'TMP_PERSONS', p_col_name=>'MANAGER_FLAG', p_gen_type=>'SQL', p_null_value_pct=>NULL, p_params=>
      q'#CASE WHEN MOD(ROWNUM,10)=0 THEN 'Y' END#'
   );
   ds_utility_krn.update_table_column_properties(p_set_id=>l_set_id, p_table_name=>'TMP_PERSONS', p_col_name=>'PER_ID_MANAGER', p_null_value_condition=>q'#:manager_flag='Y'#');
   ...
   ds_utility_krn.update_table_column_properties(p_set_id=>l_set_id, p_table_name=>'TMP_PER_ASSIGNMENTS', p_col_name=>'DATE_FROM', p_gen_type=>'SQL', p_params=>'RECORD gen.date_from');
   ds_utility_krn.update_table_column_properties(p_set_id=>l_set_id, p_table_name=>'TMP_PER_ASSIGNMENTS', p_col_name=>'DATE_TO', p_gen_type=>'SQL', p_params=>'RECORD gen.date_to');
   -- Define how to generate CLOCKINGS columns
   ds_utility_krn.update_table_column_properties(p_set_id=>l_set_id, p_table_name=>'TMP_PER_CLOCKINGS', p_col_name=>'CLOCKING_TYPE', p_gen_type=>'SQL', p_params=>'RECORD gen.thetype');
   ds_utility_krn.update_table_column_properties(p_set_id=>l_set_id, p_table_name=>'TMP_PER_CLOCKINGS', p_col_name=>'CLOCKING_DATE', p_gen_type=>'SQL', p_params=>'RECORD gen.thedate');
   ds_utility_krn.update_table_column_properties(p_set_id=>l_set_id, p_table_name=>'TMP_PER_CLOCKINGS', p_col_name=>'CLOCKING_TIME', p_gen_type=>'SQL', p_params=>'RECORD gen.thetime');
   -- Define how to generate CREDIT_CARDS columns
   ds_utility_krn.update_table_column_properties(p_set_id=>l_set_id, p_table_name=>'TMP_PER_CREDIT_CARDS', p_col_name=>'CREDIT_CARD_NUMBER', p_gen_type=>'SQL', p_params=>
      'ds_masker_krn.random_credit_card_number(p_prefix=>:cct_cd)'
   );
   ds_utility_krn.update_table_column_properties(p_set_id=>l_set_id, p_table_name=>'TMP_PER_CREDIT_CARDS', p_col_name=>'EXPIRY_DATE', p_gen_type=>'SQL', p_params=>
      'ds_masker_krn.random_expiry_date'
   );
   -- Define how to generate TRANSACTIONS columns
   ds_utility_krn.update_table_column_properties(p_set_id=>l_set_id, p_table_name=>'TMP_PER_TRANSACTIONS', p_col_name=>'TRANSACTION_TIMESTAMP', p_gen_type=>'SQL', p_params=>
   ...
   ds_utility_krn.update_table_column_properties(p_set_id=>l_set_id, p_table_name=>'TMP_PER_TRANSACTIONS', p_col_name=>'TRANSACTION_AMOUNT', p_gen_type=>'SQL', p_params=>
   ...
   ds_utility_krn.update_table_column_properties(p_set_id=>l_set_id, p_table_name=>'TMP_ORDERS', p_col_name=>'ORDER_DATE', p_gen_type=>'SQL', p_params=>q'#ds_masker_krn.obfuscate_date(sysdate,'YY')#');
   ds_utility_krn.update_table_column_properties(p_set_id=>l_set_id, p_table_name=>'TMP_ORDERS', p_col_name=>'TOTAL_PRICE', p_gen_type=>'SQL', p_params=>'0 /*TBD*/'); -- cannot compute!
   ...
   ds_utility_krn.update_table_column_properties(p_set_id=>l_set_id, p_table_name=>'TMP_STORES', p_col_name=>'STORE_NAME', p_gen_type=>'SQL', p_params=>'ds_masker_krn.random_company_name');
   ...
   ds_utility_krn.update_table_column_properties(p_set_id=>l_set_id, p_table_name=>'TMP_PRODUCTS', p_col_name=>'PRODUCT_NAME', p_gen_type=>'SQL', p_params=>
   ...
   ds_utility_krn.update_table_column_properties(p_set_id=>l_set_id, p_table_name=>'TMP_PRODUCTS', p_col_name=>'UNIT_PRICE', p_gen_type=>'SQL', p_params=>'ds_masker_krn.random_integer(10,100)');
   ds_utility_krn.update_table_column_properties(p_set_id=>l_set_id, p_table_name=>'TMP_PRODUCTS', p_col_name=>'DESCR', p_gen_type=>'SQL', p_params=>'ds_masker_krn.lorem_ipsum_clob(5000)');
   -- Define how to generate ORDER_ITEMS
   ds_utility_krn.update_table_column_properties(p_set_id=>l_set_id, p_table_name=>'TMP_ORDER_ITEMS', p_col_name=>'ORDER_LINE', p_gen_type=>'SQL', p_params=>'ROWNUM');
   ds_utility_krn.update_table_column_properties(p_set_id=>l_set_id, p_table_name=>'TMP_ORDER_ITEMS', p_col_name=>'QUANTITY', p_gen_type=>'SQL', p_params=>'ds_masker_krn.random_integer(1,8,SEED)');
   ds_utility_krn.update_table_column_properties(p_set_id=>l_set_id, p_table_name=>'TMP_ORDER_ITEMS', p_col_name=>'PRICE', p_gen_type=>'SQL', p_params=>'RECORD tmp_oit_prd_fk.unit_price * :quantity');
   COMMIT;
END;
/
...
SELECT gender, COUNT(*) cnt FROM tmp_persons GROUP BY gender; -- uniform distribution of gender
SELECT nationality, COUNT(*) cnt FROM tmp_persons GROUP BY nationality ORDER BY 2 DESC; -- non-uniform distribution of nationality (same distribution as country population)
SELECT manager_flag, COUNT(*) FROM tmp_persons GROUP BY manager_flag; -- proportion of managers
SELECT ROUND(SUM(CASE WHEN manager_flag IS NOT NULL THEN 1 ELSE 0 END) / SUM(1) * 100,2) pct_mgr from tmp_persons; -- percentage of managers
SELECT * FROM tmp_persons WHERE per_id IN (SELECT per_id_manager FROM tmp_persons) AND NVL(manager_flag,'N') = 'N'; -- no row: only managers can manage staff
SELECT cnt, COUNT(*) FROM (SELECT COUNT(*) cnt FROM tmp_persons WHERE per_id_manager IS NOT NULL GROUP BY per_id_manager) GROUP BY cnt ORDER BY 1; -- uniform distribution of managers
SELECT * FROM tmp_persons WHERE full_name != first_name||' '||last_name; -- no rows (denormalisation)
SELECT ROUND(SUM(CASE WHEN title IS NULL THEN 1 ELSE 0 END) / SUM(CASE WHEN title IS NULL THEN 0 ELSE 1 END) *100,2) pct_null from tmp_persons; -- percentage of null title
SELECT * FROM tmp_persons WHERE months_between(sysdate,birth_date)/12 NOT BETWEEN 18 AND 65; -- check age 
...
SELECT cnt, COUNT(*) FROM (SELECT COUNT(*) cnt FROM tmp_orders GROUP BY per_id) GROUP BY cnt ORDER BY 1; -- must be between 1 and 5 orders per person
SELECT cnt, COUNT(*) FROM (SELECT COUNT(*) cnt FROM tmp_orders GROUP BY sto_id) GROUP BY cnt ORDER BY 1; -- uniform distribution of stores
SELECT * FROM tmp_orders ord INNER JOIN (SELECT ord_id, SUM(price) price FROM tmp_order_items GROUP BY ord_id) oit on oit.ord_id = ord.ord_id AND oit.price != ord.total_price; -- no row (order price = sum(line price))
...
SELECT COUNT(*) FROM tmp_order_items;
SELECT cnt, COUNT(*) FROM (SELECT COUNT(*) cnt FROM tmp_order_items GROUP BY ord_id) GROUP BY cnt ORDER BY 1; -- must be between 1 and 5 items per order
SELECT cnt, COUNT(*) FROM (SELECT COUNT(*) cnt FROM tmp_order_items GROUP BY prd_id) GROUP BY cnt; -- uniform distribution of products
SELECT * FROM tmp_order_items oit INNER JOIN tmp_products prd ON prd.prd_id = oit.prd_id WHERE oit.quantity * prd.unit_price != oit.price; -- no row (line price = qty * unit price)
...
SELECT * FROM tmp_per_transactions order by per_id, ord_id;
SELECT COUNT(*) FROM tmp_per_transactions;
SELECT cnt, COUNT(*) FROM (SELECT COUNT(*) cnt FROM tmp_per_transactions GROUP BY ord_id) GROUP BY cnt; -- must be 1 or 2 transactions per order
SELECT * FROM tmp_per_transactions ptr INNER JOIN tmp_orders ord ON ord.ord_id = ptr.ord_id WHERE ptr.per_id != ord.per_id; -- no rows: credit card must belong to person's order
SELECT * FROM tmp_per_transactions ptr INNER JOIN tmp_orders ord ON ord.ord_id = ptr.ord_id WHERE ptr.transaction_timestamp < TRUNC(ord.order_date); -- no rows: transaction on or after order date
SELECT ord_id, SUM(transaction_amount) FROM tmp_per_transactions GROUP BY ord_id MINUS SELECT ord_id, total_price FROM tmp_orders; -- no rows: order amount = sum(transaction amounts)
SELECT ord_id, total_price FROM tmp_orders MINUS SELECT ord_id, SUM(transaction_amount) FROM tmp_per_transactions GROUP BY ord_id; -- some orders are not paid at all

REM Organisational entities
SELECT * FROM tmp_org_entities;
SELECT COUNT(*) FROM tmp_org_entities;
SELECT oet_cd, COUNT(*) FROM tmp_org_entities GROUP BY oet_cd ORDER BY 2; -- check number of INST (root)
SELECT cnt, COUNT(*) FROM (SELECT COUNT(*) cnt FROM tmp_org_entities GROUP BY oen_id_parent) GROUP BY cnt ORDER BY cnt; -- 4, 5 or 6 siblings (childs per parents)
SELECT * FROM tmp_org_entities det INNER JOIN tmp_org_entities mst ON mst.oen_id = det.oen_id_parent WHERE NOT det.oen_cd LIKE mst.oen_cd||'%' AND mst.oet_cd!='INST'; -- no row (acronym prefix inheritance)

REM Person's assignments
SELECT * FROM tmp_per_assignments;
SELECT COUNT(*) FROM tmp_per_assignments;
SELECT cnt, COUNT(*) FROM (SELECT COUNT(*) cnt FROM tmp_per_assignments GROUP BY per_id) GROUP BY cnt; -- must be 3, 4 or 5 assignments per person
SELECT cnt, COUNT(*) FROM (SELECT COUNT(*) cnt FROM tmp_per_assignments GROUP BY oen_id) GROUP BY cnt; -- uniform distribution of entities
SELECT * FROM tmp_per_assignments a LEFT OUTER JOIN tmp_per_assignments b ON b.per_id = a.per_id AND b.date_from = a.date_to WHERE b.date_from IS NULL AND a.date_to != TO_DATE('31/12/9999','DD/MM/YYYY'); -- no rows (consecutive periods)
SELECT a.per_id, a.date_from FROM tmp_per_assignments a LEFT OUTER JOIN tmp_per_assignments b ON b.per_id = a.per_id AND b.date_to = a.date_from WHERE b.date_from IS NULL
MINUS SELECT per_id, MIN(date_from) FROM tmp_per_assignments GROUP BY per_id; -- no rows (consecutive periods)

REM Check person's clockings
SELECT * FROM tmp_per_clockings ORDER BY per_id, clocking_date, clocking_time;
SELECT COUNT(*) FROM tmp_per_clockings;
SELECT cnt, COUNT(*) FROM (SELECT per_id, COUNT(*) cnt FROM tmp_per_clockings GROUP BY per_id) GROUP BY cnt; -- must be 100 clockings per person
SELECT cnt, COUNT(*) FROM (SELECT per_id, clocking_date, COUNT(*) cnt FROM tmp_per_clockings GROUP BY per_id, clocking_date) GROUP BY cnt; -- must be 4 clockings per person
...
REM Drop data set
--exec ds_utility_krn.delete_data_set_def(p_set_id=>ds_utility_krn.get_data_set_def_by_name('DS_GEN_TUTORIAL'));
