...
--#if 0
   ...
   ;
   ---
   -- Set encryption version (for backward compatibility)
   ---
   ...
   FUNCTION encrypt_date (
    ...
    , p_format IN VARCHAR2 := NULL  -- format: BC or AC (default: AC)
    , p_key IN VARCHAR2 := NULL     -- encryption key (default: global encryption key)
   )
   RETURN DATE
   ;
   ...
   FUNCTION encrypt_timestamp (
    ...
    , p_format IN VARCHAR2 := NULL  -- date format: BC or AC (default: AC)
    , p_key IN VARCHAR2 := NULL     -- encryption key (default: global encryption key)
   )
   RETURN TIMESTAMP
   ;
