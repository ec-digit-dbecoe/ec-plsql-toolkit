CREATE OR REPLACE PACKAGE ds_crypto_tst AS
---
...
--@#include PACKAGE BODY ds_crypto_tst encrypt_decrypt_string_for_loop
--@
--@#if "tst.exception" != "0"
...
--@#include PACKAGE BODY ds_crypto_tst encrypt_string_for_loop
--@
--@#if "tst.exception" != "0"
--@   --%test(case #tst.seq - tst.name)
--@   --%throws(tst.exception)
...
--@#include PACKAGE BODY ds_crypto_tst encrypt_decrypt_number_for_loop
--@
--@#if "tst.exception" != "0"
--@   --%test(case #tst.seq - tst.name)
--@   --%throws(tst.exception)
...
--@#include PACKAGE BODY ds_crypto_tst encrypt_number_for_loop
--@
--@#if "tst.exception" != "0"
--@   --%test(case #tst.seq - tst.name)
--@   --%throws(tst.exception)
...
--@#include PACKAGE BODY ds_crypto_tst encrypt_decrypt_integer_for_loop
--@
--@#if "tst.exception" != "0"
--@   --%test(case #tst.seq - tst.name)
--@   --%throws(tst.exception)
...
--@#include PACKAGE BODY ds_crypto_tst encrypt_integer_for_loop
--@
--@#if "tst.exception" != "0"
--@   --%test(case #tst.seq - tst.name)
--@   --%throws(tst.exception)
...
--@#include PACKAGE BODY ds_crypto_tst encrypt_decrypt_date_for_loop
--@
--@#if "tst.exception" != "0"
--@   --%test(case #tst.seq - tst.name)
--@   --%throws(tst.exception)
