DECLARE
   -- Source: https://en.wikipedia.org/wiki/List_of_most_common_surnames_in_Europe#
   my_clob CLOB;
...
Hoffmann	Hoffmann	DE#');
   l_set_id := ds_utility_krn.create_or_replace_data_set_def(p_set_name=>'EU6_FAMILY_NAMES_217', p_set_type=>'CSV', p_params=>my_clob);
   UPDATE ds_data_sets
