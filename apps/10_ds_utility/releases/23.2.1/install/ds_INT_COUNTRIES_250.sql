...
QA	QAT	Qatar	Qatar
MK	MKD	Republic of North Macedonia	Republic of North Macedonia
...
SY	SYR	Syrian Arab Republic	Syrian Arab Republic
TW	TWN	Taiwan (Province of China)	Taiwan (Province of China)
TJ	TJK	Tajikistan	Tajikistan
TZ	TZA	Tanzania, United Republic of	Tanzania, United Republic of
...
AX	ALA	Åland Islands	Aland Islands#');
   l_set_id := ds_utility_krn.create_or_replace_data_set_def(p_set_name=>'INT_COUNTRIES_250', p_set_type=>'CSV', p_params=>my_clob);
   UPDATE ds_data_sets
