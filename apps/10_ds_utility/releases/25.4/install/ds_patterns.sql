...
insert into ds_patterns (
  ...
  ,'SQL', q'#ds_masker_krn.random_value_from_data_set('INT_CURRENCIES_170.CCY_CODE',:col_data_length)#'
  ,'SQL', q'#ds_crypto_krn.encrypt_string(p_value=>:column_name, p_format=>'A')#'
);
...
insert into ds_patterns (
  ...
  ,'SQL', q'#ds_masker_krn.obfuscate_bban(p_ctry_code=>'BE',p_bban=>:column_name,p_seed=>:column_name)#'
  ,'SQL', q'#ds_masker_krn.random_bban(p_ctry_code=>'BE')#'
  ,'SQL', q'#ds_masker_krn.encrypt_bban(p_ctry_code=>'BE',p_bban=>:column_name)#'
);
...
insert into ds_patterns (
  ...
  ,'SQL', 'ds_masker_krn.random_credit_card_number'
  ,'SQL', 'ds_masker_krn.encrypt_credit_card_number(p_number=>:column_name)'
);
...
insert into ds_patterns (
  ...
  ,'SQL', 'ds_masker_krn.obfuscate_credit_card_number(p_number=>:column_name,p_seed=>:column_name)'
  ,'SQL', q'#ds_masker_krn.random_credit_card_number(p_prefix=>'5')#'
  ,'SQL', 'ds_masker_krn.encrypt_credit_card_number(p_number=>:column_name)'
);
...
insert into ds_patterns (
  ...
  ,'SQL', 'ds_masker_krn.obfuscate_credit_card_number(p_number=>:column_name,p_seed=>:column_name)'
  ,'SQL', q'#ds_masker_krn.random_credit_card_number(p_prefix=>CASE ds_masker_krn.random_integer(1,2) WHEN 1 THEN '34' ELSE '37' END)#'
  ,'SQL', 'ds_masker_krn.encrypt_credit_card_number(p_number=>:column_name)'
);
...
insert into ds_patterns (
  ...
  ,'SQL', 'ds_masker_krn.obfuscate_credit_card_number(p_number=>:column_name,p_seed=>:column_name)'
  ,'SQL', q'#ds_masker_krn.random_credit_card_number(p_prefix=>CASE ds_masker_krn.random_integer(1,2) WHEN 1 THEN '6011' ELSE '65' END)#'
  ,'SQL', 'ds_masker_krn.encrypt_credit_card_number(p_number=>:column_name)'
);
...
insert into ds_patterns (
  ...
  ,'SQL', 'ds_masker_krn.random_expiry_date'
  ,'SQL', 'ds_crypto_krn.encrypt_date(p_value=>:column_name)'
);
...
insert into ds_patterns (
  ...
  ,'SQL', q'#ds_masker_krn.random_value_from_regexp('^[a-z][a-z0-9]{5,8}@(gmail|outlook|hotmail|yahoo)\.(com|net|org|edu|gov|mil|int|be|fr|us|uk|de)')#'
  ,'SQL','ds_crypto_krn.encrypt_string(p_value=>:column_name)'
);
...
insert into ds_patterns (
  ...
  ,90, 'OR', NULL
  ,'SQL', 'ds_masker_krn.obfuscate_string(p_string=>:column_name,p_seed=>:column_name)'
  ,'SQL', q'#ds_masker_krn.random_value_from_regexp('^((25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)\.){3}(25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)$')#'
  ,'SQL','ds_crypto_krn.encrypt_string(p_value=>:column_name)'
);
...
insert into ds_patterns (
  ...
  ,90, 'OR', NULL
  ,'SQL', 'ds_masker_krn.obfuscate_string(p_string=>:column_name,p_seed=>:column_name)'
  ,'SQL', q'#ds_masker_krn.random_value_from_regexp('^([0-9A-F]{1,4}:){7}[0-9A-F]{1,4}$')#'
  ,'SQL','ds_crypto_krn.encrypt_string(p_value=>:column_name)'
);
...
insert into ds_patterns (
  ...
  ,90, 'OR', NULL
  ,'SQL', 'ds_masker_krn.obfuscate_string(p_string=>:column_name,p_seed=>:column_name)'
  ,'SQL', q'#ds_masker_krn.random_value_from_regexp('^(https?|ftp|file):\/\/([a-z0-9]+([\.\-][a-z0-9]+)*\.[a-z]{2,}|(\d{1,3}\.){3}\d{1,3})(:[0-9]{1,5})?(\/[^\s]*)?$')#'
  ,'SQL','ds_crypto_krn.encrypt_string(p_value=>:column_name)'
);
...
insert into ds_patterns (
  ...
  ,NULL, 'OR', NULL
  ,'SQL', 'ds_masker_krn.obfuscate_string(p_string=>:column_name,p_seed=>:column_name)'
  ,'SQL', q'#ds_masker_krn.random_value_from_regexp('[a-z]{6}')#'
  ,'SQL','ds_crypto_krn.encrypt_string(p_value=>:column_name)'
);
...
insert into ds_patterns (
  ...
  ,'SQL', q'#ds_masker_krn.random_value_from_regexp('^[0-9]{3}([-])[0-9]{7}\1(0[1-9]|[1-8][0-9]|9[0-7])$')#'
  ,'SQL','ds_crypto_krn.encrypt_string(p_value=>:column_name)'
);
...
insert into ds_patterns (
  ...
  ,'SQL', q'#ds_masker_krn.obfuscate_string(p_string=>:column_name,p_seed=>:column_name)#'
  ,'SQL', q'#ds_masker_krn.random_value_from_regexp('^[0-9]{2}\.(0[1-9]|1[0-2])\.(0[1-9]|[12][0-9]|3[01])[-][0-9]{3}[.](0[1-9]|[1-8][0-9]|9[0-7])$')#'
  ,'SQL','ds_crypto_krn.encrypt_string(p_value=>:column_name)'
);
...
insert into ds_patterns (
  ...
  ,'SQL', q'#ds_masker_krn.obfuscate_string(p_string=>:column_name,p_seed=>:column_name)#'
  ,'SQL', q'#ds_masker_krn.random_value_from_regexp('^[0-9]{2}\.((2[1-9]|3[0-2]|4[1-9]|5[0-2])\.(0[1-9]|[12][0-9]|3[01])|(00\.00))[-][0-9]{3}[.](0[1-9]|[1-8][0-9]|9[0-7])$')#'
  ,'SQL','ds_crypto_krn.encrypt_string(p_value=>:column_name)'
);
...
insert into ds_patterns (
  ...
  ,'SQL', q'#ds_masker_krn.obfuscate_string(p_string=>:column_name,p_seed=>:column_name)#'
  ,'SQL', q'#ds_masker_krn.random_value_from_regexp('^[A-Z]{2}\d{6}$')#'
  ,'SQL','ds_crypto_krn.encrypt_string(p_value=>:column_name)'
);
...
insert into ds_patterns (
  ...
  ,NULL, 'OR', NULL
  ,'SQL', q'#ds_masker_krn.obfuscate_string(p_string=>:column_name,p_seed=>:column_name)#'
  ,'SQL', q'#ds_masker_krn.random_value_from_regexp('[1-9][0-9]{5}')#'
  ,'SQL','ds_crypto_krn.encrypt_string(p_value=>:column_name)'
);
...
insert into ds_patterns (
  ...
  ,'SQL', q'#ds_masker_krn.random_value_from_list('M,F')#'
  ,'SQL','ds_crypto_krn.encrypt_string(p_value=>:column_name)'
);
...
insert into ds_patterns (
  ...
  ,tde_type, tde_params
   ...
   ds_pat_seq.nextval, 'Personal', 'Title (sys)', 'Y', 'CHAR(4)'
  ,'title', 'title', '^(Mr|Mrs|Ms|Miss|Mx)\.?$', ''
  ,90, 'OR', 1
  ,'SQL', q'#ds_masker_krn.random_value_from_list('Mr,Mrs,Ms,Miss,Mx')#'
  ,'SQL', q'#ds_masker_krn.random_value_from_list('Mr,Mrs,Ms,Miss,Mx')#'
  ,'SQL','ds_crypto_krn.encrypt_string(p_value=>:column_name,p_len=>:col_char_length)'
);
...
insert into ds_patterns (
  ...
  ,'SQL', q'#ds_masker_krn.random_value_from_data_set('EU6_FAMILY_NAMES_217.FAMILY_NAME_ASCII',:col_data_length)#'
  ,'SQL','ds_crypto_krn.encrypt_string(p_value=>:column_name)'
);
...
insert into ds_patterns (
  ...
  ,'SQL', q'#ds_masker_krn.random_value_from_data_set('INT_GIVEN_NAMES_250.GIVEN_NAME_ASCII',:col_data_length)#'
  ,'SQL','ds_crypto_krn.encrypt_string(p_value=>:column_name)'
);
...
insert into ds_patterns (
  ...
  ,NULL, NULL, NULL
  ,'SQL', q'#SUBSTR(ds_masker_krn.random_value_from_data_set('INT_GIVEN_NAMES_250.GIVEN_NAME_ASCII',NULL,ROWID)||' '||ds_masker_krn.random_value_from_data_set('EU6_FAMILY_NAMES_217.FAMILY_NAME_ASCII',NULL,ROWID),1,:col_data_length)#'
  ,'SQL', q'#SUBSTR(ds_masker_krn.random_value_from_data_set('INT_GIVEN_NAMES_250.GIVEN_NAME_ASCII',NULL)||' '||ds_masker_krn.random_value_from_data_set('EU6_FAMILY_NAMES_217.FAMILY_NAME_ASCII',NULL),1,:col_data_length)#'
  ,'SQL','ds_crypto_krn.encrypt_string(p_value=>:column_name)'
);
...
insert into ds_patterns (
  ...
  ,'SQL', q'#ds_masker_krn.random_value_from_data_set('INT_COUNTRIES_250.CTRY_CODE_A2',:col_data_length)#'
  ,'SQL',q'#ds_crypto_krn.encrypt_string(p_value=>:column_name, p_format=>'A')#'
);
...
insert into ds_patterns (
  ...
  ,'SQL', q'#ds_masker_krn.random_value_from_data_set('INT_COUNTRIES_250.CTRY_CODE_A3',:col_data_length)#'
  ,'SQL',q'#ds_crypto_krn.encrypt_string(p_value=>:column_name, p_format=>'A')#'
);
...
insert into ds_patterns (
  ...
  ,NULL, NULL, NULL
  ,'SQL', 'ds_masker_krn.obfuscate_string(p_string=>:column_name,p_seed=>:column_name)'
  ,'SQL', q'#ds_masker_krn.random_value_from_regexp('[1-9][0-9]{2}0')#'
  ,'SQL','ds_crypto_krn.encrypt_string(p_value=>:column_name)'
);
...
insert into ds_patterns (
  ...
  ,NULL, NULL, NULL
  ,'SQL', 'ds_masker_krn.obfuscate_string(p_string=>:column_name,p_seed=>:column_name)'
  ,'SQL', q'#ds_masker_krn.random_value_from_data_set('COLORS.NAME',NULL)||' '||ds_masker_krn.random_value_from_list('Street,Avenue,Road,Boulevard,Drive,Lane,Court,Place,Terrace,Way')#'
  ,'SQL','ds_crypto_krn.encrypt_string(p_value=>:column_name)'
);
...
insert into ds_patterns (
  ...
  ,NULL, NULL, NULL
  ,'SQL', 'ds_masker_krn.obfuscate_string(p_string=>:column_name,p_seed=>:column_name)'
  ,'SQL', q'#ds_masker_krn.random_value_from_list('Antwerp,East Flanders,Fremish Brabant,Limburg,West Flanders,Hainaut,Wallon Brabant,Namur,Liège')#'
  ,'SQL','ds_crypto_krn.encrypt_string(p_value=>:column_name)'
);
...
insert into ds_patterns (
  ...
  ,'SQL', q'#ds_masker_krn.random_value_from_data_set('EU_MAJOR_CITIES_590.CTY_NAME_ASCII',:col_data_length)#'
  ,'SQL','ds_crypto_krn.encrypt_string(p_value=>:column_name)'
);
...
insert into ds_patterns (
  ...
  ,NULL, NULL, NULL
  ,'SQL', 'ds_masker_krn.obfuscate_string(p_string=>:column_name,p_seed=>:column_name)'
  ,'SQL', q'#ds_masker_krn.random_value_from_regexp('[1|2|9]-[A-Z]{3}-[0-9]{3}')#'
  ,'SQL', 'ds_crypto_krn.encrypt_string(p_value=>:column_name)'
);
