...
--         RETURN odciconst.ERROR;
   ...
   BEGIN
      ...
      sctx := ds_read_csv_clob(elem_typ, p_set_id, 0, r_ds.params, l_clob_len, r_ds.line_sep_char, r_ds.col_sep_char, r_ds.left_sep_char, r_ds.right_sep_char, r_ds.col_names_row, r_ds.col_types_row, r_ds.data_row);
--      dbms_lob.freetemporary(lob_loc=>r_ds.params);
      RETURN odciconst.success;
   END;
