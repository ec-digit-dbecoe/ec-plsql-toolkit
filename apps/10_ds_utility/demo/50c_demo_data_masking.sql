...
ds_utility_ext.include_path(p_set_id=>ds_utility_krn.get_data_set_def_by_name('DEMO_DATA_SUB'),p_commit=>TRUE,p_path=>q'£
...
ds_utility_krn.set_source_schema('APP_DBCC_D');
ds_utility_ext.include_path(p_set_id=>ds_utility_krn.get_data_set_def_by_name('DEMO_DATA_SUB'),p_commit=>TRUE,p_path=>q'£
per.per_id[msk_type=SEQUENCE, params="app_dbcc_d.demo_per_seq", sensitive=Y, locked=Y]
£');
end;
/
exec ds_utility_krn.mask_data_set(p_set_id=>ds_utility_krn.get_data_set_def_by_name('DEMO_DATA_SUB'),p_key=>'This is the private key',p_commit=>TRUE,p_seed=>'This is a seed');
