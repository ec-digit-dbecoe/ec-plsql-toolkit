...
column[gen_type=SEQ];
per.per_id[params=DEMO_PER_SEQ];
oen.oen_id[params=DEMO_OEN_SEQ];
ord.ord_id[params=DEMO_ORD_SEQ];
sto.sto_id[params=DEMO_STO_SEQ];
prd.prd_id[params=DEMO_PRD_SEQ];
column[gen_type=SQL];
