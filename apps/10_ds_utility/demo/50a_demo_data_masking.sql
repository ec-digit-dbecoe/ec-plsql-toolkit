...
begin
   ...
   ds_utility_krn.update_mask_properties(p_table_name=>'DEMO_PERSONS', p_column_name=>'GENDER', p_msk_type=>'SHUFFLE', p_shuffle_group=>1, p_partition_bitmap=>1, p_msk_params=>NULL, p_locked_flag=>'Y');
   ds_utility_krn.update_mask_properties(p_table_name=>'DEMO_PERSONS', p_column_name=>'FIRST_NAME', p_msk_type=>'SHUFFLE', p_shuffle_group=>1, p_msk_params=>NULL, p_locked_flag=>'Y');
   ds_utility_krn.update_mask_properties(p_table_name=>'DEMO_PERSONS', p_column_name=>'LAST_NAME', p_msk_type=>'TOKENIZE', p_msk_params=>q'#ds_utility_krn.random_value_from_table(p_tab_name=>'DEMO_PERSONS',p_col_name=>'LAST_NAME',p_cycle=>'Y')#', p_options=>'enforce_uniqueness=true, encrypt_tokenized_values=true', p_locked_flag=>'Y');
   ds_utility_krn.update_mask_properties(p_table_name=>'DEMO_PERSONS', p_column_name=>'FULL_NAME', p_msk_type=>'SQL', p_msk_params=>q'#:first_name||' '||:last_name#', p_locked_flag=>'Y');
   ds_utility_krn.update_mask_properties(p_table_name=>'DEMO_PERSONS', p_column_name=>'NATIONALITY', p_msk_type=>'SQL', p_msk_params=>q'#ds_utility_krn.random_value_from_table(p_tab_name=>'DEMO_COUNTRIES',p_col_name=>'CNT_CD',p_seed=>rowid)#', p_locked_flag=>'Y');
   ds_utility_krn.update_mask_properties(p_table_name=>'DEMO_PERSONS', p_column_name=>'TITLE', p_msk_type=>'SQL', p_msk_params=>q'#'XXXX'#', p_options=>'mask_null_values=true', p_locked_flag=>'Y');
   ds_utility_krn.update_mask_properties(p_table_name=>'DEMO_PER_CREDIT_CARDS', p_column_name=>'CREDIT_CARD_NUMBER', p_msk_type=>'SQL', p_msk_params=>'ds_masker_krn.encrypt_credit_card_number(credit_card_number)', p_locked_flag=>'Y');
...
delete ds_masks;
commit;
exec ds_utility_krn.insert_mask(p_table_name=>'DEMO_PERSONS', p_column_name=>'PER_ID', p_sensitive_flag=>'Y', p_msk_type=>'SEQUENCE', p_msk_params=>'START WITH 10 INCREMENT BY 10', p_locked_flag=>'Y');
exec ds_utility_krn.mask_data_set(p_set_id=>ds_utility_krn.get_data_set_def_by_name('DEMO_DATA_SUB'),p_key=>'This is the private key',p_commit=>TRUE,p_seed=>'This is a seed');
exec ds_utility_krn.create_views(p_set_id=>ds_utility_krn.get_data_set_def_by_name('DEMO_DATA_SUB'), p_view_suffix=>'_ORI', p_mask_data=>FALSE, p_include_rowid=>TRUE);
exec ds_utility_krn.create_views(p_set_id=>ds_utility_krn.get_data_set_def_by_name('DEMO_DATA_SUB'), p_view_suffix=>'_MSK', p_mask_data=>TRUE, p_include_rowid=>TRUE);
...
delete ds_masks;
commit;
exec ds_utility_krn.insert_mask(p_table_name=>'DEMO_PERSONS', p_column_name=>'PER_ID', p_sensitive_flag=>'Y', p_msk_type=>'SEQUENCE', p_msk_params=>'demo_per_seq', p_locked_flag=>'Y');
exec ds_utility_krn.mask_data_set(p_set_id=>ds_utility_krn.get_data_set_def_by_name('DEMO_DATA_SUB'),p_key=>'This is the private key',p_commit=>TRUE,p_seed=>'This is a seed');
exec ds_utility_krn.create_views(p_set_id=>ds_utility_krn.get_data_set_def_by_name('DEMO_DATA_SUB'), p_view_suffix=>'_ORI', p_mask_data=>FALSE, p_include_rowid=>TRUE);
exec ds_utility_krn.create_views(p_set_id=>ds_utility_krn.get_data_set_def_by_name('DEMO_DATA_SUB'), p_view_suffix=>'_MSK', p_mask_data=>TRUE, p_include_rowid=>TRUE);
...
delete ds_masks;
commit;
exec ds_utility_krn.insert_mask(p_table_name=>'DEMO_PERSONS', p_column_name=>'PER_ID', p_sensitive_flag=>'Y', p_msk_type=>'SEQUENCE', p_msk_params=>'demo_per_seq@DBCC_DIGIT_01_T.CC.CEC.EU.INT', p_locked_flag=>'Y');
exec ds_utility_krn.mask_data_set(p_set_id=>ds_utility_krn.get_data_set_def_by_name('DEMO_DATA_SUB'),p_key=>'This is the private key',p_commit=>TRUE,p_seed=>'This is a seed');
exec ds_utility_krn.create_views(p_set_id=>ds_utility_krn.get_data_set_def_by_name('DEMO_DATA_SUB'), p_view_suffix=>'_ORI', p_mask_data=>FALSE, p_include_rowid=>TRUE);
exec ds_utility_krn.create_views(p_set_id=>ds_utility_krn.get_data_set_def_by_name('DEMO_DATA_SUB'), p_view_suffix=>'_MSK', p_mask_data=>TRUE, p_include_rowid=>TRUE);
...
delete ds_masks;
commit;
exec ds_utility_krn.insert_mask(p_table_name=>'DEMO_PERSONS',p_column_name=>'PER_ID', p_sensitive_flag=>'Y', p_msk_type=>'SQL', p_msk_params=>'ds_masker_krn.encrypt_number(per_id)', p_locked_flag=>'Y');
exec ds_utility_krn.mask_data_set(p_set_id=>ds_utility_krn.get_data_set_def_by_name('DEMO_DATA_SUB'),p_key=>'This is the private key',p_seed=>'This is a seed',p_commit=>TRUE);
exec ds_utility_krn.create_views(p_set_id=>ds_utility_krn.get_data_set_def_by_name('DEMO_DATA_SUB'), p_view_suffix=>'_ORI', p_mask_data=>FALSE, p_include_rowid=>TRUE);
exec ds_utility_krn.create_views(p_set_id=>ds_utility_krn.get_data_set_def_by_name('DEMO_DATA_SUB'), p_view_suffix=>'_MSK', p_mask_data=>TRUE, p_include_rowid=>TRUE);
...
delete ds_masks;
commit;
exec ds_utility_krn.insert_mask(p_table_name=>'DEMO_PERSONS',p_column_name=>'PER_ID', p_sensitive_flag=>'Y', p_msk_type=>'TOKENIZE', p_msk_params=>'ds_masker_krn.random_number(p_precision=>2,p_seed=>NULL)', p_options=>'enforce_uniqueness=true, allow_equal_value=false, encrypt_tokenized_values=true', p_locked_flag=>'Y');
exec ds_utility_krn.mask_data_set(p_set_id=>ds_utility_krn.get_data_set_def_by_name('DEMO_DATA_SUB'),p_key=>'This is the private key',p_commit=>TRUE,p_seed=>'This is a seed');
exec ds_utility_krn.create_views(p_set_id=>ds_utility_krn.get_data_set_def_by_name('DEMO_DATA_SUB'), p_view_suffix=>'_ORI', p_mask_data=>FALSE, p_include_rowid=>TRUE);
exec ds_utility_krn.create_views(p_set_id=>ds_utility_krn.get_data_set_def_by_name('DEMO_DATA_SUB'), p_view_suffix=>'_MSK', p_mask_data=>TRUE, p_include_rowid=>TRUE);
...
delete ds_masks;
commit;
exec ds_utility_krn.insert_mask(p_table_name=>'DEMO_PERSONS',p_column_name=>'PER_ID', p_sensitive_flag=>'Y', p_msk_type=>'TOKENIZE', p_msk_params=>'ds_masker_krn.encrypt_number(per_id)', p_options=>'enforce_uniqueness=true, allow_equal_value=true, encrypt_tokenized_values=true', p_locked_flag=>'Y');
exec ds_utility_krn.mask_data_set(p_set_id=>ds_utility_krn.get_data_set_def_by_name('DEMO_DATA_SUB'),p_key=>'This is the private key',p_commit=>TRUE,p_seed=>'This is a seed');
exec ds_utility_krn.create_views(p_set_id=>ds_utility_krn.get_data_set_def_by_name('DEMO_DATA_SUB'), p_view_suffix=>'_ORI', p_mask_data=>FALSE, p_include_rowid=>TRUE);
exec ds_utility_krn.create_views(p_set_id=>ds_utility_krn.get_data_set_def_by_name('DEMO_DATA_SUB'), p_view_suffix=>'_MSK', p_mask_data=>TRUE, p_include_rowid=>TRUE);
PAUSE End of scenario 5
...
delete ds_masks;
commit;
exec ds_utility_krn.insert_mask(p_table_name=>'DEMO_PERSONS', p_column_name=>'PER_ID', p_sensitive_flag=>'Y', p_msk_type=>'SEQUENCE', p_msk_params=>'DEMO_PER_SEQ', p_locked_flag=>'Y', p_options=>'differ_masking=true');
exec ds_utility_krn.mask_data_set(p_set_id=>ds_utility_krn.get_data_set_def_by_name('DEMO_DATA_SUB'),p_key=>'This is the private key',p_seed=>'This is a seed',p_commit=>TRUE);
exec ds_utility_krn.create_views(p_set_id=>ds_utility_krn.get_data_set_def_by_name('DEMO_DATA_SUB'), p_view_suffix=>'_ORI', p_mask_data=>FALSE, p_include_rowid=>TRUE);
exec ds_utility_krn.create_views(p_set_id=>ds_utility_krn.get_data_set_def_by_name('DEMO_DATA_SUB'), p_view_suffix=>'_MSK', p_mask_data=>TRUE, p_include_rowid=>TRUE);
...
exec ds_utility_krn.update_mask_properties(p_table_name=>'DEMO_PERSONS', p_column_name=>'PER_ID', p_sensitive_flag=>'Y', p_msk_type=>'SQL', p_msk_params=>'per_id+100', p_locked_flag=>'Y');
exec ds_utility_krn.mask_data_set(p_set_id=>ds_utility_krn.get_data_set_def_by_name('DEMO_DATA_SUB'),p_key=>'This is the private key',p_commit=>TRUE,p_seed=>'This is a seed');
exec ds_utility_krn.create_views(p_set_id=>ds_utility_krn.get_data_set_def_by_name('DEMO_DATA_SUB'), p_view_suffix=>'_ORI', p_mask_data=>FALSE, p_include_rowid=>TRUE);
exec ds_utility_krn.create_views(p_set_id=>ds_utility_krn.get_data_set_def_by_name('DEMO_DATA_SUB'), p_view_suffix=>'_MSK', p_mask_data=>TRUE, p_include_rowid=>TRUE);
