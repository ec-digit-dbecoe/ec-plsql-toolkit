<!-- omit in toc -->
# DPP Utility - User's Guide v25.1
...
| EXEC_PREFIX           | Enables the execution of some actions before the source schema is being exported if the value of the **STN_USAGE** column is **E** (for *export*). Those actions are the ones defined in the [**DPP_ACTIONS** table](#5125-dpp_actions---specific-actions) for the current schema and with the **E** usage and **PREFIX** type. Those actions are executed in the schema that will be exported.         | **YES** or **NO**                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |
| EXEC_POSTFIX          | Enables the execution of some actions after the source schema has been exported if the value of the **STN_USAGE** column is **E** (for *export*). Those actions are the ones defined in the [**DPP_ACTIONS** table](#5125-dpp_actions---specific-actions) for the current schema and with the **E** usage and **POSTFIX** type. Those actions are executed in the schema that has been exported.        | **YES** or **NO**                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |
| EXEC_POSTFIX_START    | Applies only within a defined scope of **EXEC_POSTFIX**. If **EXEC_POSTFIX** is not set to **YES**, this parameter is ignored. This option provides with the possibility to skip custom postfix SQL scripts that have a lower ordinal sequence number than the one specified with this option. Those scripts are the ones defined in the [**DPP_ACTIONS** table](#5125-dpp_actions---specific-actions). | a valid ordinal script sequence number (Default: undefined)                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
...
| EMAIL_RESULT                  | Emails the final result to the designated email list. If the job ended in **ERROR** the log from **dpp_job_logs** will be appended to the mail.                                                                                                                                                                                                                                                         | **Y** for yes or **N** for no                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
| EXEC_PREFIX                   | Enables the execution of some actions before the dump is being imported in the target schema if the value of the **STN_USAGE** column is **I** (for *import*). Those actions are the ones defined in the [**DPP_ACTIONS** table](#5225-dpp_actions---specific-actions) for the current schema and with the **I** usage and **PREFIX** type. Those actions are executed in the target schema.            | **YES** or **NO**                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |
| EXEC_POSTFIX                  | Enables the execution of some actions after the dump has been imported in the target schema if the value of the **STN_USAGE** column is **I** (for *import*). Those actions are the ones defined in the [**DPP_ACTIONS** table](#5225-dpp_actions---specific-actions) for the current schema and with the **I** usage and **POSTFIX** type. Those actions are executed in the target schema.            | **YES** or **NO**                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |
| EXEC_POSTFIX_START            | Applies only within a defined scope of **EXEC_POSTFIX**. If **EXEC_POSTFIX** is not set to **YES**, this parameter is ignored. This option provides with the possibility to skip custom postfix SQL scripts that have a lower ordinal sequence number than the one specified with this option. Those scripts are the ones defined in the [**DPP_ACTIONS** table](#5225-dpp_actions---specific-actions). | a valid ordinal script sequence number (Default: undefined)                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
