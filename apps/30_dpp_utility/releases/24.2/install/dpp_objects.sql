...
CREATE TABLE dpp_actions(
    ...
    atn_usage         CHAR(1 CHAR)NOT NULL,
    atn_type          VARCHAR2(8 CHAR)NOT NULL,
    execution_order   NUMBER(2)NOT NULL,
    block_text        CLOB NOT NULL,
    active_flag       CHAR(1 CHAR)NOT NULL,
    date_creat        DATE NOT NULL,
    user_creat        VARCHAR2(128 CHAR)NOT NULL,
    date_modif        DATE NOT NULL,
    user_modif        VARCHAR2(128 CHAR)NOT NULL
)
...
CREATE TABLE dpp_instances(
    ite_name          VARCHAR2(128 CHAR)NOT NULL,
    descr_eng         VARCHAR2(2000 CHAR)NOT NULL,
    descr_fra         VARCHAR2(2000 CHAR)NOT NULL,
    production_flag   CHAR(1 CHAR),
	env_name          VARCHAR2(128 CHAR) NOT NULL,
    date_creat        DATE NOT NULL,
    user_creat        VARCHAR2(128 CHAR)NOT NULL,
    date_modif        DATE NOT NULL,
    user_modif        VARCHAR2(128 CHAR)NOT NULL
...
CREATE TABLE dpp_job_logs(
    ...
    jte_cd   VARCHAR2(10 CHAR)NOT NULL,
...
CREATE TABLE dpp_option_allowed_values(
    otn_name     VARCHAR2(30 CHAR)NOT NULL,
    oav_value    VARCHAR2(1000 CHAR)NOT NULL,
    date_creat   DATE NOT NULL,
    user_creat   VARCHAR2(128 CHAR)NOT NULL,
    date_modif   DATE NOT NULL,
    user_modif   VARCHAR2(128 CHAR)NOT NULL
...
CREATE TABLE dpp_parameters(
    prr_name     VARCHAR2(30 CHAR)NOT NULL,
    prr_value    VARCHAR2(1000 CHAR)NOT NULL,
    descr_eng    VARCHAR2(2000 CHAR)NOT NULL,
    descr_fra    VARCHAR2(2000 CHAR)NOT NULL,
	ite_name     VARCHAR2(128 CHAR),
    user_creat   VARCHAR2(128 CHAR)NOT NULL,
    date_modif   DATE NOT NULL,
    user_modif   VARCHAR2(128 CHAR)NOT NULL,
    date_creat   DATE NOT NULL
...
CREATE TABLE dpp_recipients(
    sma_id       NUMBER NOT NULL,
    email_addr   VARCHAR2(100 CHAR)NOT NULL,
    date_creat   DATE NOT NULL,
    user_creat   VARCHAR2(128 CHAR)NOT NULL,
    date_modif   DATE NOT NULL,
    user_modif   VARCHAR2(128 CHAR)NOT NULL
...
CREATE TABLE dpp_roles(
    rle_name     VARCHAR2(30 CHAR)NOT NULL,
    descr_eng    VARCHAR2(2000 CHAR)NOT NULL,
    descr_fra    VARCHAR2(2000 CHAR)NOT NULL,
    date_creat   DATE NOT NULL,
    user_creat   VARCHAR2(128 CHAR)NOT NULL,
...
CREATE TABLE dpp_schema_options(
    sma_id       NUMBER NOT NULL,
    otn_name     VARCHAR2(30 CHAR)NOT NULL,
    stn_value    VARCHAR2(1000 CHAR)NOT NULL,
    stn_usage    CHAR(1 CHAR)NOT NULL,
    date_creat   DATE NOT NULL,
    user_creat   VARCHAR2(128 CHAR)NOT NULL,
    date_modif   DATE NOT NULL,
    user_modif   VARCHAR2(128 CHAR)NOT NULL
...
CREATE TABLE dpp_schema_types(
    ste_name     VARCHAR2(128 CHAR)NOT NULL,
    date_creat   DATE NOT NULL,
    user_creat   VARCHAR2(128 CHAR)NOT NULL,
    date_modif   DATE NOT NULL,
    user_modif   VARCHAR2(128 CHAR)NOT NULL
...
CREATE TABLE dpp_schemas(
    sma_id            NUMBER NOT NULL,
    ite_name          VARCHAR2(128 CHAR)NOT NULL,
    rle_name          VARCHAR2(30 CHAR),
    ste_name          VARCHAR2(128 CHAR),
    functional_name   VARCHAR2(50 CHAR)NOT NULL,
    sma_name          VARCHAR2(128 CHAR)NOT NULL,
    production_flag   CHAR(1 CHAR),
    date_from         DATE NOT NULL,
    date_to           DATE,
    date_creat        DATE NOT NULL,
