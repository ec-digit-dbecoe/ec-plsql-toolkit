...
--
   ...
   PRAGMA DEPRECATE (import_logical_name, 'import_logical_name is deprecated, use import_schema instead.');
   ...
   PRAGMA DEPRECATE (export_logical_name, 'export_logical_name is deprecated, use export_schema instead.');
