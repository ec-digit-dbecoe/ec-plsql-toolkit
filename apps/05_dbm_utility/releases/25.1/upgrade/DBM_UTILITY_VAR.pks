...
---
   ...
   SUBTYPE g_par_value_type IS VARCHAR2(4000);
   ...
   SUBTYPE g_crc_type IS VARCHAR2(32);
   ...
   TYPE ga_crc_type IS TABLE OF g_crc_type INDEX BY g_path_type;
   ...
   TYPE r_ver_type IS RECORD (
    ...
    , a_fil ga_fil_type -- file conditions
    , a_crc ga_crc_type -- file hashes
