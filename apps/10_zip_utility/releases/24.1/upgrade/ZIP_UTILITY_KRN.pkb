CREATE OR REPLACE PACKAGE BODY ZIP_UTILITY_KRN
is
  --
  ...
  l_key2 raw(4);
  l_key3 raw(4);
$IF not zip_utility_krn.use_dbms_crypto
$THEN
  ...
  begin
    ...
    then
      ...
      then -- Winzip AES encrypted
        ...
        loop
$IF zip_utility_krn.use_dbms_crypto
$THEN
...
*/
  ...
  is
$IF zip_utility_krn.use_utl_file
$THEN
...
$ELSE
  begin
    raise_application_error( -20024, 'zip_utility_krn.save_zip/utl_file not available. Set zip_utility_krn.use_utl_file := true when you have access to utl_file.' );
$END
  end save_zip;
  --
