...
CREATE TABLE mails(
    ...
    mail_mime_type              VARCHAR2(256)
        CONSTRAINT mail_mail_mime_type_nn NOT NULL,
    clob_attachment             CLOB,
    raw_attachment              RAW(2000),
    attachment_mime_type        VARCHAR2(256),
    attachment_file_name        VARCHAR2(2000),
    content_transfer_encoding   VARCHAR2(256),
    status                      VARCHAR2(30)
        CONSTRAINT mail_status_nn NOT NULL,
    force_send_flag             CHAR(1)
        CONSTRAINT mail_force_send_flag_nn NOT NULL,
    inline_attachment_flag      CHAR(1),
    priority                    INTEGER
...
Prompt Inserting meta-data

INSERT INTO mail_types ( 
   typ_id, descr, DATE_CREAT, DATE_MODIF, USER_CREAT, USER_MODIF
) VALUES ( 1 , 'Basic',SYSDATE , SYSDATE , 'PORROJE' , 'PORROJE'
);
INSERT INTO mail_types ( 
   typ_id, descr, DATE_CREAT, DATE_MODIF, USER_CREAT, USER_MODIF
) VALUES ( 2 , 'Raw attachment',SYSDATE , SYSDATE , 'PORROJE' , 'PORROJE'
);
INSERT INTO mail_types ( 
   typ_id, descr, DATE_CREAT, DATE_MODIF, USER_CREAT, USER_MODIF
) VALUES ( 3 , 'Text attachment',SYSDATE , SYSDATE , 'PORROJE' , 'PORROJE'
);
INSERT INTO mail_types ( 
   typ_id, descr, DATE_CREAT, DATE_MODIF, USER_CREAT, USER_MODIF
) VALUES ( 4 , 'Over 32k',SYSDATE , SYSDATE , 'PORROJE' , 'PORROJE'
);
INSERT INTO mail_types ( 
   typ_id, descr, DATE_CREAT, DATE_MODIF, USER_CREAT, USER_MODIF
) VALUES ( 5 , 'Text attachment over 32k',SYSDATE , SYSDATE , 'PORROJE' , 'PORROJE'
);
