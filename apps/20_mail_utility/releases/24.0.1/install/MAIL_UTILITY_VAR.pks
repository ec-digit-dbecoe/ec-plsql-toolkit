...
ACCESSIBLE BY (mail_utility_krn, mail_utility_tst)
AS
---
...
--
   ...
   SUBTYPE g_long_string_type IS VARCHAR2(4000 CHAR);
   ...
   */
   ...
   g_smtp_wallet_path          g_long_string_type := NULL;
   g_smtp_username             g_short_string_type := NULL;
   g_smtp_password             g_short_string_type := NULL;
