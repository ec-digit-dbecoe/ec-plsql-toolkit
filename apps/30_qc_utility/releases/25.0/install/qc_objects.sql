...
CREATE TABLE qc_apps (
   app_alias VARCHAR2(10 CHAR) CONSTRAINT qc_app_app_alias_nn NOT NULL
)
TABLESPACE &&tab_ts
;
...
CREATE TABLE qc_checks (
   qc_code    VARCHAR2(10 CHAR)  CONSTRAINT qc_chk_qc_code_nn NOT NULL
 , descr      VARCHAR2(250 CHAR) CONSTRAINT qc_chk_descr_nn NOT NULL
 , msg_type   VARCHAR2(1 CHAR)   DEFAULT 'E' NULL
)
TABLESPACE &&tab_ts
;
...
CREATE TABLE qc_dictionary_entries (
   app_alias  VARCHAR2(10 CHAR)  CONSTRAINT qc_dict_app_alias_nn NOT NULL
 , dict_name  VARCHAR2(30 CHAR)  CONSTRAINT qc_dict_dict_name_nn NOT NULL
 , dict_key   VARCHAR2(100 CHAR) CONSTRAINT qc_dict_dict_key_nn NOT NULL
 , dict_value VARCHAR2(750 CHAR) NULL
...
CREATE TABLE qc_patterns (
   app_alias VARCHAR2(10 CHAR) CONSTRAINT qc_pat_app_alias_nn NOT NULL
 , object_type VARCHAR2(35 CHAR) CONSTRAINT qc_pat_object_type_nn NOT NULL
 , check_pattern VARCHAR2(250 CHAR) NULL
 , anti_pattern VARCHAR2(250 CHAR) NULL
 , include_pattern VARCHAR2(250 CHAR) NULL
 , exclude_pattern VARCHAR2(250 CHAR) NULL
 , fix_pattern VARCHAR2(250 CHAR) NULL
 , msg_type VARCHAR2(1 CHAR) DEFAULT 'E' NULL
)
TABLESPACE &&tab_ts
;
...
CREATE TABLE qc_runs (
 ...
 , end_time DATE NULL
 , status VARCHAR2(10 CHAR) CONSTRAINT qc_run_status_nn NOT NULL
...
CREATE TABLE qc_run_msgs (
 ...
 , qc_code      VARCHAR2(10 CHAR)   CONSTRAINT qc_msg_qc_code_nn NOT NULL
 , app_alias    VARCHAR2(10 CHAR)   CONSTRAINT qc_msg_app_alias_nn NOT NULL
 , object_owner VARCHAR2(30 CHAR)   CONSTRAINT qc_msg_object_owner_nn NOT NULL
 , object_type  VARCHAR2(35 CHAR)   CONSTRAINT qc_msg_object_type_nn NOT NULL
 , object_name  VARCHAR2(100 CHAR)  CONSTRAINT qc_msg_object_name_nn NOT NULL
 , msg_type     VARCHAR2(1 CHAR)    CONSTRAINT qc_msg_msg_type_nn NOT NULL
 , msg_text     VARCHAR2(400 CHAR)  CONSTRAINT qc_msg_msg_text_nn NOT NULL
 , msg_hidden   VARCHAR2(1 CHAR)    NULL
 , sort_order   NUMBER         NULL
 , fix_type     VARCHAR2(30 CHAR)   NULL -- object type
 , fix_name     VARCHAR2(100 CHAR)  NULL -- object name
 , fix_op       VARCHAR2(10 CHAR)   NULL -- RENAME/DROP
 , fix_status   VARCHAR2(10 CHAR)   NULL -- SUCCESS/FAILURE
 , fix_msg      VARCHAR2(400 CHAR)  NULL
 , fix_ddl      VARCHAR2(400 CHAR)  NULL
 , fix_locked   VARCHAR2(1 CHAR)    NULL -- Y/N
 , fix_time     DATE           NULL
...
CREATE TABLE qc_run_stats (
 ...
 , run_id_to    NUMBER         NULL
 , qc_code      VARCHAR2(10 CHAR)   CONSTRAINT qc_stat_qc_code_nn NOT NULL
 , app_alias    VARCHAR2(10 CHAR)   CONSTRAINT qc_stat_app_alias_nn NOT NULL
 , object_owner VARCHAR2(30 CHAR)   CONSTRAINT qc_stat_object_owner_nn NOT NULL
 , object_type  VARCHAR2(35 CHAR)   CONSTRAINT qc_stat_object_type_nn NOT NULL
